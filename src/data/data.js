...
const Portalada = createPageData( 1, "Virtual reconstruction of the entrance of the Ripoll Monastery", "portalada", temporalImages,
	[ Techs.OpenGL, Techs.CPlusPlus, Techs.Qt ], [ Roles.RenderingEngineer ], 
	[Categories.CG]
);

const Tarraco = createPageData( 2, "Virtual Tarraco", "tarraco", temporalImages,
	[ Techs.OpenGL, Techs.CPlusPlus, Techs.Qt ], [ Roles.RenderingEngineer ], 
	[Categories.CG]
);

const BAIP = createPageData( 3, "BAIP 2020", "baip", temporalImages,
	[ Techs.OpenGL, Techs.CPlusPlus, Techs.Qt ], [ Roles.RenderingEngineer ], 
	[Categories.CG]
);

const AlterFitness = createPageData( 4, "Alter Fitness", "af", temporalImages,
...
const BergaActiva = createPageData( 5, "Berga Activa", "ba", temporalImages,
...
const IASTracker = createPageData( 6, "IASTracker", "iastracker", temporalImages,
...
const CityVibes = createPageData( 7, "City vibes", "cv", temporalImages,
	[Techs.JS, Techs.HTML5, Techs.CSS3, Techs.Python, Techs.Cordova, Techs.Leaflet ], [ Roles.AppDeveloper ], 
	[Categories.App]
);

const Instamaps = createPageData( 8, "Instamaps, Storymaps and prototypes", "instamaps", temporalImages,
...
const Websites = createPageData( 10, "Websites", "header", temporalImages,
...
export { Portalada, Tarraco, BAIP, AlterFitness, BergaActiva, 
	IASTracker, CityVibes, Instamaps, Canhemon, Websites, Other };