...
const Page1 = createPageData( 1, "Ripoll's entrance", "portalada", temporalImages,
	[ Techs.OpenGL, Techs.CPlusPlus, Techs.Qt ], [ Roles.RenderingEngineer ], 
	[Categories.CG]
);

const Page2 = createPageData( 2, "Virtual Tarraco", "header", temporalImages,
	[ Techs.OpenGL, Techs.CPlusPlus, Techs.Qt ], [ Roles.RenderingEngineer ], 
	[Categories.CG]
);

const Page3 = createPageData( 3, "BAIP 2020", "header", temporalImages,
	[ Techs.OpenGL, Techs.CPlusPlus, Techs.Qt ], [ Roles.RenderingEngineer ], 
	[Categories.CG]
);
...
//Access control, 3d spinning, vector tile optimizer, algorithms, apunts i projectes deep learning
