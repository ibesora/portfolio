			...
			<div>
				...
				<Page isLast={true} {...pages.Other}>
					...
					<ul>
						...
						<li><b>Portfolio:</b> This website has been developed using React and features some interesting techniques like <Link href="https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images">responsive images</Link> and the <Link href="https://css-tricks.com/the-blur-up-technique-for-loading-background-images/">"Blur Up" technique for loading images</Link>. It follows almost all <Link href="https://developers.google.com/web/tools/lighthouse/">lighthouse recommendations</Link> and has a 97% score on the web app quality report. You can find all the <Link href="https://github.com/ibesora/portfolio">portfolio react app code in this repository</Link></li>
